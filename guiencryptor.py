...
root.title("Password Encryptor-Decryptor")#Title for the window
...
label1 = tk.Label(root,text= "Enter the Password",width=20,bg="MediumPurple1")#creating a label which the user can view
...
label7 =tk.Label(root,text="Converted Password ",width=20,bg="MediumPurple1")#creating label for the converted text
